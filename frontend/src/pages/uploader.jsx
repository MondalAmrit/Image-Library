                ...
                <form onSubmit={handleSubmit} encType='multipart/form-data' className="flex flex-col items-center w-full mt-2">
                    ...
                    <div className="w-full">
                        <input
                            ...
                            className="h-10 w-full mt-5 p-2 outline-none text-sm text-zinc-900 border border-zinc-300 rounded-lg cursor-pointer bg-zinc-200 focus:outline-none "
                        />
                        <p className="mt-1 text-sm text-zinc-800 ">PNG, JPG or JPEG.</p>
                    </div>
                    <div className="w-full">
                        <input
                            type="text"
